...
minimize Total_Cost:
	...
	+ 0.25 * sum {e in ENERGY_ST, t in TIME, ns in DIS_LIN_SEG, b in BERN_COEF_D3}
			 (
			 	CG [e,ns] * W_ES_G [e,t,ns,b]
			 )
	- 0.25 * sum {e in ENERGY_ST, t in TIME, hs in CH_LIN_SEG, b in BERN_COEF_D3}
			 (
			 	CD [e,hs] * W_ES_D [e,t,hs,b]
			 )
